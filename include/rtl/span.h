...
namespace rtl
{
    ...
    class span
    {
        ...
        template <typename U, std::size_t ArrayExtent,
                  typename
                  = typename std::enable_if<(__detail::__is_dynamic_offset<Extent>
                                             || __detail::__is_dynamic_offset<ArrayExtent>)>::type>
        using __is_compatible_array = __detail::__is_array_convertible<T, U>;

        template <typename Ref>
        using __is_compatible_ref
            = __detail::__is_array_convertible<T, std::remove_reference_t<Ref>>;
