...
namespace rtl
{
    ...
    namespace __detail
    {
        ...
        __sv_check(size_t size, size_t pos, const char *s)
        {
            if ( pos > size )
                {
                    char msg[300]{};
                    snprintf(msg, sizeof(msg), "%s: pos (which is %zu) > size (which is %zu)", s,
                             pos, size);
    ...
    class basic_string_view
    {
        ...
        static_assert(is_trivially_copyable_v<CharT> && is_trivially_default_constructible_v<CharT>
      ...
      public:
        ...
        constexpr basic_string_view(const CharT *str) noexcept
            : m_str{ str }, m_len{ traits_type::length(str) }
        {
        }
        ...
        constexpr basic_string_view(const std::basic_string<CharT> &str) noexcept
            : m_str{ str.data() }, m_len{ str.length() }
        {
        }
      ...
      public:
        ...
        constexpr basic_string_view
        subview(size_type pos = 0, size_type n = npos) const
        {
      ...
      public:
        ...
        constexpr int
        compare(size_type pos1, size_type n1, basic_string_view str, size_type pos2,
                size_type n2) const
        {
        ...
        constexpr int
        compare(size_type pos1, size_type n1, const CharT *str, size_type pos2, size_type n2) const
        {
      ...
      public:
        constexpr bool
        starts_with(basic_string_view pre) const noexcept
        {
        ...
        constexpr bool
        starts_with(CharT pre) const noexcept
        {
            return !this->empty() && traits_type::eq(this->front(), pre);
        }

        constexpr bool
        starts_with(const CharT *pre) const noexcept
        {
            return this->starts_with(basic_string_view{ pre });
        }

        constexpr bool
        ends_with(basic_string_view end) const noexcept
        {
            const size_type len     = this->size();
            const size_type end_len = end.size();
            return len >= end_len
                   && traits_type::compare(this->end() - end_len, end.data(), end_len) == 0;
        }

        constexpr bool
        ends_with(CharT end) const noexcept
        {
            return !this->empty() && traits_type::eq(this->back(), end);
        }

        constexpr bool
        ends_with(const CharT *end) const noexcept
        {
      ...
      public:
        constexpr bool
        contains(basic_string_view str) const noexcept
        {
            return this->find(str) != npos;
        }

        constexpr bool
        contains(CharT c) const noexcept
        {
            return this->find(c) != npos;
        }

        constexpr bool
        contains(const CharT *str) const noexcept
        {
            return this->find(str) != npos;
        }
        ...
        // find_last_of
        constexpr size_type
        find_last_of(basic_string_view str, size_type pos = npos) const noexcept
        {
        ...
        constexpr size_type
        find_last_of(const CharT *str, size_type pos = 0) const noexcept
        {
        ...
        // find_first_not_of
        constexpr size_type
        find_first_not_of(basic_string_view str, size_type pos = 0) const noexcept
        {
        ...
        // find_last_not_of
        constexpr size_type
        find_last_not_of(basic_string_view str, size_type pos = npos) const noexcept
        {
        ...
        constexpr size_type
        find_last_not_of(const CharT *str, size_type pos = npos) const noexcept
        {
      ...
      private:
        ...
        static_compare(size_type n1, size_type n2) noexcept
        {
    ...
    basic_string_view<CharT, Traits>::find(const CharT *str, size_type pos,
                                           size_type n) const noexcept
    {
        if ( n == 0 )
    ...
    template <typename CharT, typename Traits>
    constexpr typename basic_string_view<CharT, Traits>::size_type
    basic_string_view<CharT, Traits>::rfind(const CharT *str, size_type pos,
                                            size_type n) const noexcept
    {
        if ( n <= this->size() )
            {
    ...
    template <typename CharT, typename Traits>
    constexpr typename basic_string_view<CharT, Traits>::size_type
    basic_string_view<CharT, Traits>::find_first_of(const CharT *str, size_type pos,
                                                    size_type n) const noexcept
    {
    ...
    template <typename CharT, typename Traits>
    constexpr typename basic_string_view<CharT, Traits>::size_type
    basic_string_view<CharT, Traits>::find_last_of(const CharT *str, size_type pos,
                                                   size_type n) const noexcept
    {
        size_type size = this->size();
        if ( size && n )
    ...
    template <typename CharT, typename Traits>
    constexpr typename basic_string_view<CharT, Traits>::size_type
    basic_string_view<CharT, Traits>::find_first_not_of(const CharT *str, size_type pos,
                                                        size_type n) const noexcept
    {
    ...
    template <typename CharT, typename Traits>
    constexpr typename basic_string_view<CharT, Traits>::size_type
    basic_string_view<CharT, Traits>::find_last_not_of(const CharT *str, size_type pos,
                                                       size_type n) const noexcept
    {
        size_type size = this->size();
        if ( size )
...
namespace std
{
    ...
    {
        size_t
        operator()(const rtl::string_view &str) const noexcept
        {
    ...
    {
        size_t
        operator()(const rtl::wstring_view &str) const noexcept
        {
            return rtl::__detail::__hash_impl::hash(
                str.data(), str.length() * sizeof(rtl::wstring_view::traits_type::char_type));
        }
    };
    ...
    {
        size_t
        operator()(const rtl::u8string_view &str) const noexcept
        {
            return rtl::__detail::__hash_impl::hash(
                str.data(), str.length() * sizeof(rtl::u8string_view::traits_type::char_type));
        }
    };
#endif // C++20
    ...
    {
        size_t
        operator()(const rtl::u16string_view &str) const noexcept
        {
            return rtl::__detail::__hash_impl::hash(
                str.data(), str.length() * sizeof(rtl::u16string_view::traits_type::char_type));
        }
    };
    ...
    {
        size_t
        operator()(const rtl::u32string_view &str) const noexcept
        {
            return rtl::__detail::__hash_impl::hash(
                str.data(), str.length() * sizeof(rtl::u32string_view::traits_type::char_type));
        }
    };
#endif // CXX_LIVE_MIN_VERSION_17
}
